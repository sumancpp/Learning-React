...
const App = () => {
  ...
  return (
    <div className='bg-black overflow-auto h-screen p-4 text-white'>
      <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-7 gap-4 h-[82%] p-2'>
        {printUserData}
      </div>

      <div className='flex justify-center gap-6 items-center p-4 mt-10'>
        <button
